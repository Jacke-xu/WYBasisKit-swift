...
extension String {
    ...
    /// 时间戳转字符串
    func  wy_timestampConvertDate(dateFormat: DateDisplayFormat?) -> String {
        ...
        let useDateFormat = (dateFormat == nil) ? .yearMonthDayAndhourMinutes : dateFormat
