...
public struct WYActivityConfig {
    ...
    public static var animationSize: CGSize = CGSize(width: wy_screenWidth(45), height: wy_screenWidth(45))
...
public extension WYActivityConfig {
    ...
    private static func defaultGifInfo() -> WYGifInfo {
        ...
        for index in 0..<8 {
            defaultImages.append(UIImage.wy_named("indicator0" + "\(index + 1)", inBundle: "WYActivity", subdirectory: "Indicator"))
        }
...
private class WYActivityLoadingView: UIView {
    ...
    func layoutActivity(content: Any?, contentView: UIView, animation: WYActivityAnimation, delay: TimeInterval, config: WYActivityConfig) {
        ...
        if content != nil {
            ...
            var controSize = CGSize(width: controWidth + (wy_screenWidth(10) * 2), height: frame.size.height + textlabel.frame.size.height)
