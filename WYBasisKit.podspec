Pod::Spec.new do |kit|
  ...
  kit.default_subspecs = 'Extension'
    ...
    kit.subspec 'Extension' do |extension|
       ...
       extension.frameworks = 'Foundation', 'UIKit', 'LocalAuthentication', 'Photos', 'CoreFoundation', 'CommonCrypto.CommonDigest'
    ...
    kit.subspec 'Activity' do |activity|
       ...
       activity.frameworks = 'Foundation', 'UIKit', 'CommonCrypto.CommonDigest'
