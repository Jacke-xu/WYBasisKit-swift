...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../WYBasisKit/Layout/ChatView/WYChatView.bundle"
  ...
  install_resource "${PODS_ROOT}/WYBasisKit/WYBasisKit/Activity/WYActivity.bundle"
  install_resource "${PODS_ROOT}/WYBasisKit/WYBasisKit/Localizable/WYLocalizable.bundle"
  install_resource "${PODS_ROOT}/WYBasisKit/WYBasisKit/Layout/BannerView/WYBannerView.bundle"
fi
